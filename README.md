...
2. Follow the instruction on this (LINK)[https://docs.microsoft.com/en-us/azure/active-directory/develop/quickstart-v1-add-azure-ad-app] (*it may be a LITTLE outdated but it is straight forward*)
